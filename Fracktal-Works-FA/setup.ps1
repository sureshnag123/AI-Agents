# Fracktal Works F&A - Automated Setup Script
# Run this script to set up the agent environment from scratch
# Usage: .\setup.ps1

Write-Host "============================================" -ForegroundColor Cyan
Write-Host "Setting up: Fracktal Works F&A" -ForegroundColor Cyan
Write-Host "============================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "  3. Select 'Fracktal Works F&A' from Copilot Chat agent dropdown" -ForegroundColor White
Write-Host ""
