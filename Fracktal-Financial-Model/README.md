...
**Just double-click:** `fracktal-financial-model.code-workspace`
...
Then select **"fracktal-financial-model"** from the Copilot Chat agent dropdown and start working!
...
3. **Select your agent** - Choose "fracktal-financial-model" from the agent dropdown
...
```
fracktal-financial-model/
├── fracktal-financial-model.code-workspace # ← Double-click to open VS Code!
