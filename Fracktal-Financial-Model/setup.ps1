# fracktal-financial-model - Automated Setup Script
# Run this script to set up the agent environment from scratch
# Usage: .\setup.ps1

Write-Host "============================================" -ForegroundColor Cyan
Write-Host "Setting up: fracktal-financial-model" -ForegroundColor Cyan
Write-Host "============================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "  3. Select 'fracktal-financial-model' from Copilot Chat agent dropdown" -ForegroundColor White
Write-Host ""
